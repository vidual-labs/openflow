export const LOCALES = {
  en: {
    ...
    errorSlotUnavailable: 'Sorry, that time was just taken. Please pick another one.',
    thankYou: 'Thank you!',
  ...
  de: {
    ...
    errorSlotUnavailable: 'Dieser Termin wurde gerade vergeben. Bitte wähle einen anderen.',
